...
Use this reference when the user asks to write an article from an X/Twitter Article or longform post that contains many inline screenshots, tutorial frames, or a video thumbnail.
