...
Use these notes when the user asks for an article based on an OpenAI `openai.com/index/...` announcement and the rendered page is JS-heavy, Cloudflare-protected, or only partially accessible.
