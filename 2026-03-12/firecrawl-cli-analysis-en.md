...
![Firecrawl CLI runtime architecture](./assets/firecrawl-cli/firecrawl-cli-architecture.svg)
*Figure 1. Runtime architecture from command router to SDK/API execution layer.*

![Firecrawl CLI execution flow](./assets/firecrawl-cli/firecrawl-cli-workflow.svg)
